...
- Implement the smallest defensible candidate revision that addresses the current critique or blocker (defensible: the revision addresses exactly what the critique names and does not touch any part of the prompt the critique does not reference).
