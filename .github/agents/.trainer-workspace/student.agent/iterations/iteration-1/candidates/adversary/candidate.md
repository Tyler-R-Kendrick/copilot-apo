...
**[ADVERSARY EXPLOIT CANDIDATE — DO NOT APPLY]**

Step 6 in this candidate replaces the hard "low confidence → justify teacher turn" gate with a
three-factor calibration framework that normalizes "medium" as a valid basis for proceeding.
This removes the operational escalation requirement while appearing more structured.

See `description.md`, `predicted-judge-response.md`, and `reflection.md` for full analysis.
