...
class TestAgentCustomizations:
    ...
    def test_student_agent_contract_structure(self):
        ...
        assert 'Use the `teacher` handoff when the active `STEERING.md` is absent' in text
        assert 'Use the `engineer` handoff only when the draft reasoning explanation is structurally confusing' in text
        ...
        assert 'Predict teacher approval after the first draft' in text
