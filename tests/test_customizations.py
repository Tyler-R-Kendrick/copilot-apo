...
class TestAgentCustomizations:
    ...
    def test_student_agent_contract_structure(self):
        ...
        assert 'Use the `engineer` handoff only when the reasoning explanation needs prompt-engineering or Trace-specific reframing' in text
        assert 'smallest defensible candidate revision' in text
        ...
        assert 'tree-of-thought' in text
        assert 'chain-of-uncertainty-thought' in text
