...
class TestAgentCustomizations:
    ...
    def test_student_agent_contract_structure(self):
        ...
        assert 'Use the `engineer` handoff only when your draft rationale is ambiguous or contradictory' in text
        ...
        assert 'forecast whether the `teacher` would approve the revision using these criteria' in text
